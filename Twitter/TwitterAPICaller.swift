...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "qn96Lhj1ie8nwP8lrMYYRhRye", consumerSecret: "djtcpLi2Zq21q5ADTHHgomeYuHaOPl0tothc9LPLzl1iaii9w9")
    var loginSuccess: (() -> ())?
    ...
    func postTweet(tweetString:String, success: @escaping () -> (), failure: @escaping(Error) -> ()) {
        ...
        //let url2 = https://api.twitter.com/1.1/statuses/update.json
